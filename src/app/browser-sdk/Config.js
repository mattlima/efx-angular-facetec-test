export var Config = (function () {
    ...
    var DeviceKeyIdentifier = "dD3vSQsABT0Wpsuqa66PeIG1UEwLFtyS";
    ...
    function retrieveConfigurationWizardCustomization(FaceTecSDK) {
        ...
        var borderColor = "#0164ca";
        var ovalColor = "#0164ca";
        var dualSpinnerColor = "#0164ca";
        var textColor = "#0164ca";
        var buttonAndFeedbackBarColor =  "#0164ca";
        var buttonAndFeedbackBarTextColor = "#ffffff";
        var buttonColorHighlight = "#3fe2bf";
        var buttonColorDisabled = "#e2e2e2";
